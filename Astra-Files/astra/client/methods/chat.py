...
class ChatMethods:
 ...
 async def pin_message(self, message_id: str, pin: bool = True, duration: int = 86400) -> bool:
  """
  Pins or unpins a message.
  Duration is in seconds (default 24h).
  """
  try:
   return await self._client.api.pin_message(message_id, pin=pin, duration=duration)
  except Exception as e:
   logger.info(f"Failed to pin/unpin {message_id}: {e}")
   raise ChatOperationError(f"Failed to pin/unpin {message_id}: {e}") from e
 ...
 async def send_photo(self, chat_id: str, media: Any, **kwargs) -> Message:
  """Alias for client.media.send_photo."""
  return await self._client.media.send_photo(chat_id, media, **kwargs)

 async def send_video(self, chat_id: str, media: Any, **kwargs) -> Message:
  """Alias for client.media.send_video."""
  return await self._client.media.send_video(chat_id, media, **kwargs)

 async def send_audio(self, chat_id: str, media: Any, **kwargs) -> Message:
  """Alias for client.media.send_audio."""
  return await self._client.media.send_audio(chat_id, media, **kwargs)

 async def send_document(self, chat_id: str, media: Any, **kwargs) -> Message:
  """Alias for client.media.send_document."""
  return await self._client.media.send_document(chat_id, media, **kwargs)

 async def send_sticker(self, chat_id: str, media: Any, **kwargs) -> Message:
  """Alias for client.media.send_sticker."""
  return await self._client.media.send_sticker(chat_id, media, **kwargs)
