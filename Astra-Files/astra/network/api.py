...
class EngineAPI:
 ...
 async def click(self, selector: str) -> bool:
  """Triggers a native DOM click on a selector."""
  return await self._bridge.call("click", selector)

 async def context_menu(self, selector: str) -> bool:
  """Triggers a native context-menu event on a selector."""
  return await self._bridge.call("contextMenu", selector)

 async def add_favorite_sticker(self, message_id: str) -> bool:
  """Adds a sticker message to the user's favorites."""
  return await self._bridge.call("addFavoriteSticker", message_id)
